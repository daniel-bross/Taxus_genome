...
#SBATCH --cpus-per-task=10			# CPUs requested per task
#SBATCH --mem=50000MB				# RAM allocation (per array job)
#SBATCH --partition=main			# node group (small-jobs or main)
#SBATCH --job-name=04_ldpruning			# job name to be used for logs, etc.
...
bash scripts/prune.sh $SLURM_CPUS_PER_TASK $SLURM_MEM_PER_NODE
