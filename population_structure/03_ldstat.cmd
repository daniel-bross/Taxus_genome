...
#SBATCH --mem=150000MB				# RAM allocation (per array job)
#SBATCH --partition=main			# node group (small-jobs or main)
#SBATCH --job-name=03_ldstat			# job name to be used for logs, etc.
...
bash scripts/get_ld_stats.sh $SLURM_NTASKS $SLURM_MEM_PER_NODE
