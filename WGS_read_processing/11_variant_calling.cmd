...
#SBATCH --array 1-111%1
#SBATCH --job-name=10_bcftools_vcf
#SBATCH --mail-type=BEGIN,FAIL,END
#SBATCH --mail-user=
#SBATCH --output slurm_logs/%A_%x/%x_%a.out
#SBATCH --error slurm_logs/%A_%x/%x_%a.err

# Arrays: One per sequence as determined by prep_calling.sh
...
bash scripts/bcftools_calling.sh ${SLURM_ARRAY_TASK_ID}
